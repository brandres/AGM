...
var renderer, scene, camera, cubo, floorMat, bulbLight, bulbMat, hemiLight;
var cameraControls;
var angulo = -0.01;
var sliderVRotacion;
...
function update() {
    ...
    cubo.position.set(sliderPosXCamara.value, sliderPosYCamara.value, sliderPosZCamara.value);
